...
class Application
{
	...
	String m_sProgrammer = "Marc Molnar - mgm1349@rit.edu";
...
private:
	...
	//value will be added to teh x values and value changer
	//will be added to value but once it reaches a certain point it will move back
	float value = 0.0f;
	float valueChanger = 0.01f;
