...
private:
	String m_sProgrammer = "Marc Molanr - mgm1349@rit.edu"; //programmer
	...
	MyEntity* steve = nullptr; //steve entity
	MyEntity* creeper = nullptr; //creeper entity

	AStar* aStar = nullptr;
	vector3	creeperMovement = vector3(0.0f);
	matrix4 move = matrix4(0.0f);
	int creeperNode = 0;
