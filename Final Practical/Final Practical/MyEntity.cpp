...
vector3 Simplex::MyEntity::GetPosition(void)
{
	return position;
}

//updates the position of the entity
void Simplex::MyEntity::SetPositon(vector3 vPosition)
{
	position = vPosition;
}

//updates the shortest path of the entity
void Simplex::MyEntity::SetShortestPath(int vShortestPath)
{
	shortestPath = vShortestPath;
}

//returns the shortest path of the entity
int Simplex::MyEntity::GetShortestPath(void)
{
	return shortestPath;
}

//Sets the distance to the end node 
void Simplex::MyEntity::SetDistanceLength(int vDistance)
{
	distance = vDistance;
}

//returns the distance to the end node
int Simplex::MyEntity::GetDistanceLength(void)
{
	return distance;
}
